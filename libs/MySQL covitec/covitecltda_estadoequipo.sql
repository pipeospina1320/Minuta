...
CREATE TABLE `estadoequipo` (
  `estequi_id` int(11) NOT NULL AUTO_INCREMENT,
  `estequi_nombre` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`estequi_id`)
...
INSERT INTO `estadoequipo` VALUES (1,'NUEVO'),(2,'DETERIORADO'),(3,'DAÑADO'),(4,'BUENO');
