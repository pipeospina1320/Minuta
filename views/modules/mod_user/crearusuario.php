  ...
  <div class="x_content">
    ...
    <form id="demo-form2"  data-parsley-validate class="form-horizontal form-label-left" name="frmregister[]">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" name="frmregister[]" id="frmregisteruser2" id="frmregisteruser2" class="form-control col-md-7 col-xs-12">
        </div>
      </div>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <select class="form-control"  name="frmregister[]" id="frmregistersede">
          <option value="0"></option>
          <?php
          $selectsede = new HomeController();
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <select class="form-control"  name="frmregister[]" id="frmregisterarea">
          <option value="0"></option>
          <?php
          $selectsede = new HomeController();
