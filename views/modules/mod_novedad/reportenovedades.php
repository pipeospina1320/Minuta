    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" name="frmnovedad[]"
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Firma digital:</label>
                    <div class="control-label col-md-6 col-sm-8 col-xs-12">
                        <canvas id="canvas" width="350%" height="100%" style="border:solid black 1px;">
                            <input type='hidden' name="filenovedadFirma" id='imagenFirma'/>
                        </canvas>
                    </div>
                </div>
