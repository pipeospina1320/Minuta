        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="MisionVision" class="site_title"><i class="fa fa-hospital-o"></i>
                        <span>Covitec Ltda.</span></a>
                </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-building-o"></i> Mi Empresa <span
                                ...
                                <li><a><i class="fa fa-edit"></i> Consulta <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="ConsultaNotificaciones">Consulta Notificacion</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-users"></i> Visitantes <span
                                                class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-desktop"></i> Configuración <span
                                                class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                ...
                <?php } else {
                    echo '<script language="javascript"> window.location="Error403-Rol" </script>';
                } ?>
                <!-- /sidebar menu Error Rol -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="views/assets/images/user.png"
                                     alt=""><?php echo $nombresession . " " . $apellidosession; ?>
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="javascript:;" class="dropdown-toggle info-number" id="numbernoty"
                               data-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-envelope-o"></i>
                                <span class="badge bg-green"><?php $numberNoty = new NotificacionController();
                                    echo $numberNoty->numbersNotification(); ?></span>
                            </a>
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                <?php $noty = new NotificacionController();
                                $noty->reportNotification(); ?>
                            </ul>
                        </li>
                    </ul>
                </nav>
